...
@Component({
  selector: 'app-progenglish',
  templateUrl: './progenglish.component.html',
  styleUrls: ['./progenglish.component.scss']
})
export class ProgenglishComponent implements OnInit {
  apiUrl = 'https://673728afaafa2ef22232dd7f.mockapi.io/Mapi'; // استخدام endpoint واحد فقط
  students: Student[] = [];
